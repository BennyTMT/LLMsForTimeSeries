...
'''
    ...
    sh scripts/long_term_forecasting/ETTh1.sh
    sh scripts/long_term_forecasting/ETTh1_data_size.sh
    
    sh scripts/long_term_forecasting/ETTh1_attention.sh
    sh scripts/long_term_forecasting/ETTh1_embedding.sh
    
    sh scripts/long_term_forecasting/ETTh1_simple.sh
    
    sh scripts/long_term_forecasting/all_ETT_attention.sh
    
    sh scripts/long_term_forecasting/other_DATA_attention.sh
    
    sh scripts/long_term_forecasting/randomInit_ETT.sh
'''
